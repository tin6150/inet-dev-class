...
#### this version look at value, x10, and print that number of line for the point.
#### so to produce a dot density map more suitable for heatmap, i hope :)
#### ../ZWEDCcsv2gson_heatmap.py  > ZWEDC_densityDot.geojson
